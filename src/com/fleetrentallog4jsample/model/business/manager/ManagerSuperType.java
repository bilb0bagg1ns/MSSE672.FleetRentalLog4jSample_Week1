...
public abstract class ManagerSuperType {
     ...
     * (business and below)
     *
     * @throws PropertyFileNotFoundException Properties file could bot be
     * loaded.
     */
     ...
     *
     * By making the application Manager be aware of the property file used in
     * the application, this allows the Factory to just deal with the
     * application manager and not be aware of the property manager
     *
